      ...
      <section className="bg-primary pt-32 pb-20 md:pt-40 md:pb-24 px-6 md:px-margin-desktop">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="font-body-lg text-white/80 max-w-2xl text-lg md:text-xl leading-relaxed">
            As a dedicated non-life insurance agency, Solace Point moves away from the aggressive, fear-based marketing of traditional brokers. Instead, we provide a calm destination for absolute security—the exact point where worry ends and restoration begins.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-7">
              <ScrollReveal direction="left" distance="40px" delay={200}>
                <div className="aspect-[16/10] rounded-3xl overflow-hidden shadow-2xl relative">
                  <img
                    alt="Four professional team members in suits on laptops during a board meeting training session"
                    className="w-full h-full object-cover"
                    src={aboutPhoto}
                  />
                </div>
