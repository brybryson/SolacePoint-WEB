...
const engineeringProducts = [
  {
    ...
    desc: 'Protects civil engineering projects, buildings, and machinery during construction from accidents, theft, and natural disasters.',
    covers: [
  ...
  {
    title: 'Erection All Risk (EAR) Insurance',
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?q=80&w=1200&auto=format&fit=crop',
    alt: 'Steel structure and machinery installation',
    desc: 'Covers risks associated with the installation, assembly, and testing of machinery and steel structures.',
    covers: [
      'Machinery installation & assembly',
      'Steel structure erection',
      'Testing & commissioning phase',
      'Accidental damage during erection',
      'Third-party liability',
      'Faulty workmanship'
    ],
    idealFor: [
      'Industrial equipment installers',
      'Steel fabricators',
      'Machinery suppliers',
  ...
  {
    title: 'Machinery Breakdown (MB) Insurance',
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200&auto=format&fit=crop',
    alt: 'Industrial machinery in factory',
    desc: 'Covers sudden and unforeseen physical damage to machinery, such as boiler explosions or mechanical breakdown.',
    covers: [
      'Boiler explosions',
  ...
  },
  {
    ...
    desc: "Protects high-value electronic devices, such as computers and telecommunications equipment, on an 'all-risks' basis.",
    covers: [
    ...
    idealFor: [
      ...
      'Data centers',
      'Telecom providers',
      'Offices with high-value electronics',
      'Tech startups'
    ]
  }
];
...
const whyChoose = [
  { name: 'Complete Project Protection', desc: 'Coverage from groundbreaking to commissioning', icon: 'foundation' },
  { name: 'All-Risk Coverage', desc: 'Comprehensive protection against unforeseen events', icon: 'shield' },
  { name: 'Third-Party Liability', desc: 'Protection against claims from third parties', icon: 'groups' },
  { name: 'Machinery & Equipment', desc: 'Full coverage for construction and industrial equipment', icon: 'precision_manufacturing' },
  { name: 'Fast Claims Processing', desc: 'Quick resolution to minimize project delays', icon: 'speed' },
  { name: 'Expert Support', desc: 'Dedicated Solace Point team for engineering projects', icon: 'engineering' }
];
    ...
    <div className="font-sans antialiased text-on-surface bg-surface-container-lowest min-h-screen selection:bg-secondary/30">
        ...
        <ScrollReveal direction="up" className="relative z-10">
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="font-body-lg text-white/80 max-w-2xl text-lg md:text-xl leading-relaxed mb-10">
              Comprehensive protection for construction projects, machinery installation, industrial equipment, and electronic systems. Solace Point Engineering Insurance covers every phase — from construction to commissioning to operation.
            </p>
            <button 
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop">
          <ScrollReveal direction="up">
            <div className="text-center mb-16 md:mb-20">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl text-on-surface font-bold">Our Engineering Products</h2>
              <p className="text-on-surface-variant mt-6 text-lg max-w-2xl mx-auto">From construction sites to data centers — complete coverage for every engineering risk.</p>
            </div>
          </ScrollReveal>

          <div className="flex flex-col gap-24 md:gap-32">
            {engineeringProducts.map((product, idx) => {
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop relative z-10">
          <ScrollReveal direction="up">
            <div className="mb-16 md:mb-20 text-center max-w-3xl mx-auto">
              <h2 className="font-display-lg text-3xl md:text-5xl text-on-surface font-bold mb-6">Why Choose Solace Point Engineering Insurance?</h2>
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Complete project protection from groundbreaking to commissioning. We secure the risks so you can focus on building.
              </p>
            </div>
      ...
      <section className="py-32 md:py-48 bg-primary text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none">
          <img src="https://images.unsplash.com/photo-1531834685032-c34bf0d84c77?q=80&w=2000&auto=format&fit=crop" alt="Large industrial project" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop text-center relative z-10">
          <ScrollReveal direction="up">
            <h2 className="font-display-lg text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">Protect Your <br className="hidden md:block"/> Engineering Projects</h2>
            <p className="text-white/80 text-lg md:text-xl mb-16 max-w-2xl mx-auto leading-relaxed">
              Whether you're building infrastructure, installing machinery, or operating industrial equipment — Solace Point Engineering Insurance has you covered.
            </p>
