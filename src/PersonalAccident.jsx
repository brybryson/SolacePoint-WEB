...
const paProducts = [
  {
    ...
    desc: 'Family Secure provides comprehensive personal accident insurance for the whole family. Protect your loved ones with coverage that includes accidental death, disability, and medical expenses for all family members under one policy.',
    covers: [
      'Parents & children coverage',
  ...
  {
    title: 'Kasambahay Secure',
    image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=1200&auto=format&fit=crop',
    desc: 'Kasambahay Secure offers comprehensive accident insurance designed specifically for household helpers and yayas. Give your kasambahay the protection they deserve while working in your home.',
    covers: [
      'Household helpers & yayas',
  ...
  },
  {
    ...
    desc: 'SME Secure provides affordable accident insurance for small and medium enterprise employees. Protect your workforce with comprehensive coverage that keeps your business running smoothly.',
    covers: [
      'SME employees & workers',
      'Group accident coverage',
      'Work & non-work related accidents',
      'Flexible coverage options'
    ]
  },
  {
    title: 'Student Secure',
    image: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=1200&auto=format&fit=crop',
    desc: "Student Secure offers comprehensive accident insurance for students of all levels. From elementary to college, protect your child's future with coverage for accidents at school, home, or anywhere.",
    covers: [
  ...
  {
    title: 'Guardia Secure',
    image: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=1200&auto=format&fit=crop',
    desc: 'Guardia Secure is designed for security guards, police officers, and public protectors. Comprehensive accident insurance for those who put their lives on the line to keep us safe.',
    covers: [
      'Security guards & police officers',
      'On-duty & off-duty coverage',
      'High-risk occupation protection',
  ...
  },
  {
    ...
    desc: 'OFW Secure provides comprehensive accident insurance for Overseas Filipino Workers. Protect yourself while working abroad with coverage that follows you wherever you go.',
    covers: [
  ...
  {
    title: 'Faculty Secure',
    image: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=1200&auto=format&fit=crop',
    desc: 'Faculty Secure offers comprehensive accident insurance for teachers and educators. Protect those who shape our future with coverage designed specifically for the education sector.',
    covers: [
      'Teachers & educators',
      'Public & private school faculty',
      'School & commute coverage',
...
const whatsCovered = [
  { name: 'Accidental Death', icon: 'shield' },
  { name: 'Permanent Disability', icon: 'accessible' },
  { name: 'Medical Expenses', icon: 'local_hospital' },
  { name: 'Hospitalization', icon: 'bed' },
  { name: 'Emergency Treatment', icon: 'emergency' },
  { name: 'Rehabilitation Costs', icon: 'fitness_center' },
  { name: 'Funeral Expenses', icon: 'church' },
  { name: 'Loss of Income', icon: 'payments' },
  { name: '24/7 Worldwide Coverage', icon: 'public' }
];
    ...
    <div className="font-sans antialiased text-on-surface bg-surface-container-lowest min-h-screen selection:bg-secondary/30">
        ...
        <ScrollReveal direction="up" className="relative z-10">
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="font-body-lg text-white/80 max-w-2xl text-lg md:text-xl leading-relaxed mb-10">
              Comprehensive protection for every Filipino — from families and students to workers and professionals. Solace Point Personal Accident Insurance provides peace of mind when life takes an unexpected turn.
            </p>
            <button 
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop">
          <ScrollReveal direction="up">
            <div className="text-center mb-16 md:mb-20">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl text-on-surface font-bold">Our Personal Accident Products</h2>
              <p className="text-on-surface-variant mt-6 text-lg max-w-2xl mx-auto">Tailored accident insurance solutions for every Filipino — from families to students, workers to OFWs.</p>
            </div>
          </ScrollReveal>

          <div className="flex flex-col gap-24 md:gap-32">
            {paProducts.map((product, idx) => {
          ...
          <ScrollReveal direction="up">
            <div className="mb-16 md:mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="max-w-3xl">
                <h2 className="font-display-lg text-3xl md:text-4xl text-on-surface font-bold mb-6">Why Choose Solace Point Personal Accident Insurance?</h2>
                <p className="text-on-surface-variant text-lg leading-relaxed">
                  Tailored protection for every stage of life and every profession.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {[
                { name: 'Comprehensive Coverage', icon: 'verified_user' },
                { name: 'Affordable Premiums', icon: 'payments' },
                { name: 'Fast Claims Processing', icon: 'speed' },
                { name: '24/7 Support', icon: 'support_agent' },
                { name: 'Customizable Plans', icon: 'tune' },
                { name: 'Family Protection', icon: 'family_restroom' },
                { name: 'Workplace Coverage', icon: 'corporate_fare' },
                { name: 'Student Safety', icon: 'school' },
                { name: 'OFW Protection', icon: 'flight_takeoff' }
              ].map((item, idx) => (
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop relative z-10">
          <ScrollReveal direction="up">
            <div className="text-center mb-16 md:mb-20">
              ...
              <h2 className="font-display-lg text-3xl md:text-5xl font-bold mb-6">Complete Protection Against Accidents</h2>
              <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
                Our Personal Accident Insurance policies provide financial protection when accidents happen. Whether at home, at work, at school, or abroad, you and your loved ones are covered.
              </p>
            </div>
          </ScrollReveal>
      ...
      <section className="py-32 md:py-48 bg-primary text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none">
          <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2000&auto=format&fit=crop" alt="Team/Family" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="max-w-container-max mx-auto px-6 md:px-margin-desktop text-center relative z-10">
          <ScrollReveal direction="up">
            <h2 className="font-display-lg text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">Protect What <br className="hidden md:block"/> Matters Most</h2>
            <p className="text-white/80 text-lg md:text-xl mb-16 max-w-2xl mx-auto leading-relaxed">
              Get comprehensive Personal Accident Insurance for you and your family. Choose from our specialized plans designed for families, students, workers, and professionals.
            </p>
